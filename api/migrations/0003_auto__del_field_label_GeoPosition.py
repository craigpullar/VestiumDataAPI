...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Label.GeoPosition'
        db.delete_column(u'api_label', 'GeoPosition')


    def backwards(self, orm):
        # Adding field 'Label.GeoPosition'
        db.add_column(u'api_label', 'GeoPosition',
                      self.gf('geoposition.fields.GeopositionField')(default='', max_length=42),
                      keep_default=False)
