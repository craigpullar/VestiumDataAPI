...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.numFollowers'
        db.add_column(u'api_user', 'numFollowers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.numPosts'
        db.add_column(u'api_user', 'numPosts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Post.pubDate'
        db.alter_column(u'api_post', 'pubDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'User.numFollowers'
        db.delete_column(u'api_user', 'numFollowers')

        # Deleting field 'User.numPosts'
        db.delete_column(u'api_user', 'numPosts')


        # Changing field 'Post.pubDate'
        db.alter_column(u'api_post', 'pubDate', self.gf('django.db.models.fields.DateTimeField')())
