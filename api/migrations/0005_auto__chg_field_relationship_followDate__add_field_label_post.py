...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relationship.followDate'
        db.alter_column(u'api_relationship', 'followDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Adding field 'Label.post'
        db.add_column(u'api_label', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='labels', to=orm['api.Post']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Relationship.followDate'
        db.alter_column(u'api_relationship', 'followDate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 4, 0, 0)))
        # Deleting field 'Label.post'
        db.delete_column(u'api_label', 'post_id')
