...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_blogcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.User'])),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Article'])),
        ...
        db.send_create_signal(u'api', ['BlogComment'])

        # Adding model 'Article'
        db.create_table(u'api_article', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.User'])),
            ...
            ('background_image_slug', self.gf('django.db.models.fields.CharField')(max_length=63)),
        ))
        db.send_create_signal(u'api', ['Article'])

        # Adding M2M table for field photos on 'Article'
        m2m_table_name = db.shorten_name(u'api_article_photos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'api.article'], null=False)),
            ('photo', models.ForeignKey(orm[u'api.photo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['article_id', 'photo_id'])

        # Adding field 'User.blogEnabled'
        db.add_column(u'api_user', 'blogEnabled',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'api_blogcomment')

        # Deleting model 'Article'
        db.delete_table(u'api_article')

        # Removing M2M table for field photos on 'Article'
        db.delete_table(db.shorten_name(u'api_article_photos'))

        # Deleting field 'User.blogEnabled'
        db.delete_column(u'api_user', 'blogEnabled')
