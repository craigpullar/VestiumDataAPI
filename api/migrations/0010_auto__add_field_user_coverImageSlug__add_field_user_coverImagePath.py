...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.coverImageSlug'
        db.add_column(u'api_user', 'coverImageSlug',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.coverImagePath'
        db.add_column(u'api_user', 'coverImagePath',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.coverImageSlug'
        db.delete_column(u'api_user', 'coverImageSlug')

        # Deleting field 'User.coverImagePath'
        db.delete_column(u'api_user', 'coverImagePath')
    ...
    models = {
        ...
        u'api.user': {
            ...
            'coverImagePath': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'coverImageSlug': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
